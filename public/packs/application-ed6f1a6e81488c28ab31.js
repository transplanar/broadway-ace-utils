...
var SocialMediaMessageBuilder = function (_React$Component) {
  ...
  _createClass(SocialMediaMessageBuilder, [{
    ...
    value: function parseHours(event) {
      var hoursArr = event.target.value.split(' ');

      var totalHours = hoursArr.reduce(function (acc, elem) {
        var num = parseFloat(elem);
        return (num < 6 ? num : num - 0.5) + acc;
      });

      console.log("Setting " + totalHours.flatten);
      this.setState({
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-ed6f1a6e81488c28ab31.js.map