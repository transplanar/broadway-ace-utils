...
var SocialMediaMessageBuilder = function (_React$Component) {
  ...
  _createClass(SocialMediaMessageBuilder, [{
    ...
    value: function handleChange(event) {
      this.setState({ rhbText: event.target.value });
    ...
    value: function handleSubmit(event) {
      ...
      var queryUrl = 'api/v1/search/?query=' + this.state.query + '&resultLimit=' + this.state.resultLimit;
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-2683d0340a0b02058750.js.map