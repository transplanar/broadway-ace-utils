...
throw new Error("Module build failed: SyntaxError: Unexpected token, expected , (76:31)\n\n  74 |     const reducer = (acc, cur) => {\n  75 |       var add =  (acc <= 6 ? acc : (acc - 0.5));\n> 76 |       console.log(`Add ${add}` to ${cur})\n     |                                ^\n  77 |       return add + cur;\n  78 |     };\n  79 |     \n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-2f342c8d29974156ede5.js.map