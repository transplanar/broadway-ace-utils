...
throw new Error("Module build failed: SyntaxError: Unexpected token, expected } (68:62)\n\n  66 |         Width (inches): <input type='number' value={this.state.input1} name = 'input1' onChange={this.handleChange} />\n  67 |         Height (inches): <input type='number' value={this.state.input2} name = 'input2' onChange={this.handleChange} />\n> 68 |         {this.state.error ? <div>this.state.error<div> : {Area: this.getSqft()}\n     |                                                               ^\n  69 |         <div>Cost: {this.getCost()}</div>\n  70 |       </React.Fragment>\n  71 |     );\n");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__SquareFootCalculator_jsx___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__SquareFootCalculator_jsx__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-154d45394634dde8d3ff.js.map