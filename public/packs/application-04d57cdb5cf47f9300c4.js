...
var SquareFootCalculator = function (_React$Component) {
    ...
    _createClass(SquareFootCalculator, [{
        ...
        value: function getCost() {
            return "$" + parseFloat(this.state.cost).toFixed(2);
        }
    }, {
        key: "getSqft",
        value: function getSqft() {
            return parseFloat(this.state.sqft).toFixed(3) + "ft<sup>2</sup>";
        }
    }, {
        key: "render",
        value: function render() {
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-04d57cdb5cf47f9300c4.js.map