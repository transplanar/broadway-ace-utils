...
throw new Error("Module build failed: SyntaxError: Unexpected token (61:97)\n\n  59 |       <React.Fragment>\n  60 |         <div>Screen Calculator</div>\n> 61 |         Width (inches): <input type='number' value={this.state.input1} name = 'input1' onChange={::this.handleChange} />\n     |                                                                                                  ^\n  62 |         Height (inches): <input type='number' value={this.state.input2} name = 'input2' onChange={::this.handleChange} />\n  63 |         <div>Square Feed: {this.getSqft()} </div>\n  64 |         <div>Cost: {this.getCost()}</div>\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-93b27ec6a71a97e0bbcb.js.map