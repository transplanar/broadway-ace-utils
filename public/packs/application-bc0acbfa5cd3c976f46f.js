...
throw new Error("Module build failed: SyntaxError: Invalid left-hand side in assignment expression (73:21)\n\n  71 |     console.log(`Hours are ${hoursArr}`);\n  72 |     \n> 73 |     const reducer = (acc, cur) = > acc + curr;\n     |                      ^\n  74 |     \n  75 |     var totalHours = hoursArr.reduce(reducer);\n  76 |     \n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-bc0acbfa5cd3c976f46f.js.map